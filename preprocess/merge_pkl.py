...
def merge_masif_to_existing_pkl(pkl_file, output_dir, name, pk, rmsd, output_file=None):  
    """  
    ...
    try:  
        ...
        # 设置MaSIF输出路径  
        precomputed_dir = os.path.join(output_dir, 'precomputed', 'complex_A')  
        desc_dir = os.path.join(output_dir, 'descriptors', 'complex_A')  
