...
# Creation Date and Time:  Mon Jul  7 15:06:34 2025
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 4.716300e-02
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 1.424280e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 8.331030e-01
Vprtstp: iteration = 0
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.201314e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.419122e+00
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.158000e-03
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.194890
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 7.202840e-01
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (129, 129, 129)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 4.458000e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (065, 065, 065)
Vbuildops: Galer: (033, 033, 033)
Vbuildops: Galer: (017, 017, 017)
Vbuildops: Galer: (009, 009, 009)
Vbuildops: Galer: (005, 005, 005)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 1.395860e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 2.986364e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.181418e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.393488e+00
Vpmg_setPart:  lower corner = (-41.5015, 8.401, 1.389)
Vpmg_setPart:  upper corner = (28.9095, 74.162, 70.372)
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 4.080000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 1.000000e-06
...
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 4.879705e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Mon Jul  7 15:06:40 2025
